...
class SlidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post slides_url, params: { slide: { content: @slide.content, description: @slide.description, title: @slide.title } }
    end
  ...
  test "should update slide" do
    patch slide_url(@slide), params: { slide: { content: @slide.content, description: @slide.description, title: @slide.title } }
